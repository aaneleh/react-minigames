...
function Forca() {
    ...
    return (
        <div>
            ...
            <main className="text-center h-main p-4 bg-white">
                <h2 className="font-bold text-3xl">Forca</h2>
                
                    <div className="mt-8 grid overflow-hidden grid-row-3 justify-center"> 
                        {/* SEÇÃO DE CIMA */}
                        <div className="w-screen overflow-hidden flex justify-around order-solid border-2 border-black">
                            {/* VIDAS */}
                            ...
                            <div className="h-64 w-main flex flex-col justify-around">
                                ...
                                {/* LETRAS CHUTADAS */}
                                <div className="flex justify-center font-bold text-lime-700">
                                    Letras Erradas: 
                        ...
                        {/* SEÇÃO DO MEIO */}
                        <div className="grid grid-row-3 grid-cols-10 gap-1 m-2 border-solid border-2 border-black p-4">
                            { alfabeto.map((letra, index) => (
                                <p className="cursor-pointer border-solid border-2 border-black p-2 duration-100 hover:bg-lime-300"
                                    key={index}
                                    letra={letra}
                                    onClick={recebeLetra}
                                    >
